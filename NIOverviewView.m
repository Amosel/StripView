...
- (id)initWithFrame:(CGRect)frame {
  if ((self = [super initWithFrame:frame])) {
    ...
    _scrollView.scrollIndicatorInsets = UIEdgeInsetsMake(0, self.pageHorizontalMargin,
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (CGRect)frameForPageAtIndex:(NSInteger)itemIndex {
  ...
  pageFrame.origin.x = (bounds.size.width * itemIndex) + self.pageHorizontalMargin;
...
- (void)setTranslucent:(BOOL)translucent {
  if (_translucent != translucent) {
    ...
    _scrollView.indicatorStyle = (_translucent
